class Library():
    ...
    def new_book(self, name_book_, year_, author):
...
class Book():
    ...
    def __init__(self, name_book, year, author):
...
class Author():
    ...
    def __init__(self, name_author, country, birthday):
